...
You can download the 2025 dataset of IP TLS certificates here: [https://yevheniya.com/data/isoc_pulse/certificates.json](https://yevheniya.com/data/isoc_pulse/certificates.json) (file size 902.51M).
